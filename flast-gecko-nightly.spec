...
Source0: https://github.com/FascodeNet/flast-gecko/releases/download/2021-02-07-09-32/firefox.ja.linux-x86_64.tar.bz2
BuildRoot: %{_tmppath}/%{name}-%{version}-buildroot
%global debug_package %{nil}
%description
Flast Browser on Gecko
%prep
...
%install
mkdir -p $RPM_BUILD_ROOT/opt/flast-gecko-nightly/
...
EOF
cat <<EOF > $RPM_BUILD_ROOT/usr/share/applications/flast-gecko-nightly.desktop
[Desktop Entry]
Name=Flast Gecko Nightly
...
Exec=/opt/flast-gecko-nightly/firefox %u
...
Name[zh_CN]=新建窗口
Name[zh_TW]=開新視窗
Exec=/opt/flast-gecko-nightly/firefox --new-window %u
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/opt/flast-gecko-nightly/firefox --private-window %u
EOF
